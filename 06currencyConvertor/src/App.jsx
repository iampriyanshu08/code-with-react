...
function App() {
  ...
  return (
    <>
    <div className ="flex flex-wrap justify-center items-center bg-no-repeat">
    <div className ="w-1/2 h-screen  flex flex-wrap justify-center items-center  bg-no-repeat " style={{
    ...
    <div
      className="w-3/6 h-screen flex flex-wrap justify-center items-center bg-cover bg-no-repeat"
      style={{
